...
public class GrandCompanyProvisionModule : BaseModule
{
    public override string Name => "GC Provisioning";
    ...
    public void IncrementProgress(int amount = 1)
    {
        ...
        if (_current >= _maximum)
        {
            Plugin.Instance.NotificationManager.SendModuleComplete(Name, "GC Provisioning completed!");
        }
    }

    public override void DrawConfig()
    {
        ImGui.TextUnformatted("GC Provisioning Settings");
        ImGui.Separator();
        ImGui.TextWrapped("Track daily Grand Company provisioning missions.");

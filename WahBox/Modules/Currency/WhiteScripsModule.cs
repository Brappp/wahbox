...
public class WhiteScripsModule : BaseModule, ICurrencyModule
{
    ...
    {
        ImGui.TextUnformatted("White Scrips Tracking");
        ImGui.Separator();
        ImGui.TextWrapped("White Scrips are earned from crafting and gathering collectables.");
        ImGui.Spacing();

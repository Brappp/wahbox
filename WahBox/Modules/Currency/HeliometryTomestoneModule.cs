...
public class HeliometryTomestoneModule : BaseModule, ICurrencyModule
{
    public override string Name => "Tomestones of Heliometry";
    ...
    public override void Initialize()
    {
        ...
        // Initialize Heliometry tomestone tracking
        _trackedCurrencies.Add(new TrackedCurrency 
        { 
            Type = CurrencyType.Item,
            ItemId = 48,  // Tomestones of Heliometry
            Threshold = 1400,
            MaxCount = 2000,
            Enabled = true,
            ShowInOverlay = true,
    ...
    public override void DrawConfig()
    {
        ...
        ImGui.Text("Tomestones of Heliometry Settings");
        ImGui.Separator();
        ImGui.TextWrapped("Limited tomestone currency - obtained from high-end duties.");

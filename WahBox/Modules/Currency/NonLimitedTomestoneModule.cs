...
public class NonLimitedTomestoneModule : BaseModule, ICurrencyModule
{
    public override string Name => "Non-Limited Tomestone";
    ...
    public NonLimitedTomestoneModule(Plugin plugin) : base(plugin)
    {
    ...
    public override void Initialize()
    {
        ...
        // Initialize non-limited tomestone tracking
    ...
    public override void DrawConfig()
    {
        ...
        ImGui.Text("Non-Limited Tomestone Settings");
        ImGui.Separator();

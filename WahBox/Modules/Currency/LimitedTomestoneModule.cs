...
public class LimitedTomestoneModule : BaseModule, ICurrencyModule
{
    public override string Name => "Limited Tomestone";
    ...
    public LimitedTomestoneModule(Plugin plugin) : base(plugin)
    {
        IconId = 65048; // Limited tomestone icon (slightly different)
    }
    ...
    public override void Initialize()
    {
        ...
        // Initialize limited tomestone tracking
    ...
    public override void DrawConfig()
    {
        ...
        ImGui.Text("Limited Tomestone Settings");
        ImGui.Separator();

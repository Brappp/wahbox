...
public class TrophyCrystalsModule : BaseModule, ICurrencyModule
{
    ...
    public override void Initialize()
    {
        ...
        // Initialize Trophy Crystals tracking
    ...
    {
        ImGui.TextUnformatted("Trophy Crystals Tracking");
        ImGui.Separator();
        ImGui.TextWrapped("Trophy Crystals are earned from Crystalline Conflict PvP.");
        ImGui.Spacing();

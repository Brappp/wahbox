...
public class SackOfNutsModule : BaseModule, ICurrencyModule
{
    public override string Name => "Sack of Nuts";
    ...
    {
        ImGui.TextUnformatted("Sack of Nuts Tracking");
        ImGui.Separator();
        ImGui.TextWrapped("Sack of Nuts are earned from Shadowbringers and Endwalker hunt marks.");
        ImGui.Spacing();

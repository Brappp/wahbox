...
public class SkybuildersScripModule : BaseModule, ICurrencyModule
{
    ...
    public override void Initialize()
    {
        ...
        // Initialize Skybuilders' Scrips tracking
        _trackedCurrencies.Add(new TrackedCurrency 
        { 
            Type = CurrencyType.Item,
            ItemId = 28063,  // Skybuilders' Scrips
            Threshold = 7500,
            MaxCount = 10000,
            Enabled = true,
            ShowInOverlay = true,
    ...
    {
        ImGui.TextUnformatted("Skybuilders' Scrips Tracking");
        ImGui.Separator();
        ImGui.TextWrapped("Skybuilders' Scrips are earned from Ishgardian Restoration activities.");
        ImGui.Spacing();

...
public class PoeticTomestoneModule : BaseModule, ICurrencyModule
{
    ...
    {
        ImGui.TextUnformatted("Allagan Tomestones of Poetics");
        ImGui.Separator();
        ImGui.TextWrapped("The primary tomestone currency for level 50-80 content.");
        ImGui.Spacing();

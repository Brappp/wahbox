...
public class BicolorGemstonesModule : BaseModule, ICurrencyModule
{
    ...
    public override void Initialize()
    {
        ...
        // Initialize Bicolor Gemstones tracking
        _trackedCurrencies.Add(new TrackedCurrency 
        { 
            Type = CurrencyType.Item,
            ItemId = 26807,  // Bicolor Gemstones
            Threshold = 800,
            MaxCount = 1000,
            Enabled = true,
            ShowInOverlay = true,
    ...
    {
        ImGui.TextUnformatted("Bicolor Gemstones Tracking");
        ImGui.Separator();
        ImGui.TextWrapped("Bicolor Gemstones are earned from FATEs in Shadowbringers and Endwalker zones.");
        ImGui.Spacing();

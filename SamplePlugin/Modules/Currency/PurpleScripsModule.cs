...
public class PurpleScripsModule : BaseModule, ICurrencyModule
{
    ...
    {
        ImGui.TextUnformatted("Purple Scrips Tracking");
        ImGui.Separator();
        ImGui.TextWrapped("Purple Scrips are the current endgame scrips for crafting and gathering.");
        ImGui.Spacing();

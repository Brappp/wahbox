...
public class LevequestsModule : BaseModule
{
    public override string Name => "Levequests";
    ...
    public void IncrementProgress(int amount = 1)
    {
        ...
        if (_current >= _maximum)
        {
            Plugin.Instance.NotificationManager.SendModuleComplete(Name, "Levequests completed!");
        }
    }

    public override void DrawConfig()
    {
        ImGui.TextUnformatted("Levequests Settings");
        ImGui.Separator();
        ImGui.TextWrapped("Track leve allowances (100 max, 6 per day).");

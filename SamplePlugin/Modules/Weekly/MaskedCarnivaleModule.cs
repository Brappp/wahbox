...
public class MaskedCarnivaleModule : BaseModule
{
    public override string Name => "Masked Carnivale";
    ...
    private void UpdateResetTime()
    {
        ...
        // Masked Carnivale resets on Tuesday at 8:00 UTC
    ...
    {
        _isComplete = true;
        Plugin.Instance.NotificationManager.SendModuleComplete(Name, "Masked Carnivale completed!");
    }

    public override void DrawConfig()
    {
        ImGui.TextUnformatted("Masked Carnivale Settings");
        ImGui.Separator();
        ImGui.TextWrapped("Track weekly challenges in the Blue Mage arena.");
